<fieldset class="5st_ques">
    <div class="single_question dob_question">
        ...
        <label id="dob-error" class="error" for="dob" style="display:none;">You must be at least 18 years of age.</label>
    </div> 
    <button type="button" name="previous" id="dob_bck" class="previous action-button secondary_cta btn_fixed">Back</button>
    <button type="button" name="next" id="dob_next" class="next action-button primary_cta btn_fixed">Next</button>
</fieldset>